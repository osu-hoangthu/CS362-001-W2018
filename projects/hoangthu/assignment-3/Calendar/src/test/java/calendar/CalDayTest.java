...
public class CalDayTest {
    ...
    public void testIterator1(){
        ...
        appointment = new Appt(5, 35, 5,4, 2018, "Date Night", "Gonna be lit");
        linkedAppt.addAppt(appointment);
        assertNotNull(linkedAppt.iterator());
    }
    @Test
    public void testConstructor(){
        CalDay linkedAppt;
        linkedAppt = new CalDay();
        assertFalse(linkedAppt.isValid());
    }
    @Test
    public void testIteratorFalse(){
        CalDay linkedAppt;
        linkedAppt = new CalDay();
        assertNull(linkedAppt.iterator());
    }

    @Test
    public void addInvalidAppt(){
        Appt appointment;
        CalDay linkedAppt;
        GregorianCalendar test;
        test = new GregorianCalendar();
        ...
        test.set(GregorianCalendar.DATE, 21);
        linkedAppt = new CalDay(test);
        appointment = new Appt(5, 300, 5,9, 2018, "Date Night", "Gonna be lit");
        linkedAppt.addAppt(appointment);
        assertNotNull(linkedAppt);
    }
    @Test
    public void setNullAppointment() {
        Appt appointment;
        CalDay linkedAppt;
        GregorianCalendar test;
        test = new GregorianCalendar();
    ...
    public void testToString2(){
        ...
        test.set(GregorianCalendar.DATE, 21);
        linkedAppt = new CalDay(test);
        appointment = new Appt(50, 35, 5,10, 2018, "Date Night", "Gonna be lit");
        linkedAppt.addAppt(appointment);
        assertNotNull(linkedAppt.toString());
    }
}
